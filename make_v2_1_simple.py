...
scenes = [
    make_scene("Your 9-5 shouldn't\nhurt this much.", WHITE, 2.5),
    make_scene("POV: Your back is\nscreaming at 3 PM.",  WHITE, 2.5),
    make_scene("The $35 desk worker\ncheat code.",        GOLD,  3.0),
    make_scene("Stop the hunch.",                         GOLD,  2.0),
]

out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "output", "v2_1_simple.mp4")
