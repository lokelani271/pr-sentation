"""
v2_1.mp4 — 4 scenes, 10s, 1080x1920, 30fps, no audio
"""
...
def put_text(img, lines, cy, fnt, color, alpha=1.0):
    """Draw multi-line text centered vertically around cy."""
...
scenes = [
    make_scene(["Your 9-5 shouldn't", "hurt this much."],       WHITE, 2.5),
    make_scene(["POV: Your back is", "screaming at 3 PM."],     WHITE, 2.5),
    make_scene(["The $35 desk worker", "cheat code."],           GOLD,  3.0),
    make_scene(["Stop the hunch."],                              GOLD,  2.0),
]
