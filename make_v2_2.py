...
scenes = [
    make_scene(["Your neck tension", "is killing your focus."],      WHITE, 2.5),
    make_scene(["Why your productivity", "is dropping at 3 PM."],    WHITE, 2.5),
    make_scene(["Reset your body", "in 30 seconds."],                GOLD,  3.0),
    make_scene(["Link in bio."],                                      GOLD,  2.0),
]
