...
scenes = [
    make_scene(["Nobody on Zoom knows", "I'm wearing this."],      WHITE, 2.5),
    make_scene(["How I survive", "back-to-back meetings."],        WHITE, 2.5),
    make_scene(["Hot for knots.", "Cold for aches."],              GOLD,  3.0),
    make_scene(["Work pain-free."],                                GOLD,  2.0),
]
