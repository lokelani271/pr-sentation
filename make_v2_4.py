...
scenes = [
    make_scene(["Sitting 8h is", "the new smoking."],          WHITE, 2.5),
    make_scene(["Your spine after", "5 years at a desk."],     WHITE, 2.5),
    make_scene(["Manage the damage", "for $35."],               GOLD,  3.0),
    make_scene(["Start your reset."],                           GOLD,  2.0),
]
