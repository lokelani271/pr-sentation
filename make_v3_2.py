...
scenes = [
    make_scene(["Hate ice baths?", "Same."],                      WHITE, 2.5),
    make_scene(["There's a smarter", "way to recover."],          WHITE, 2.5),
    make_scene(["Targeted cold therapy.", "No freeze."],           GOLD,  3.0),
    make_scene(["Recover smarter."],                               GOLD,  2.0),
]
