...
scenes = [
    make_scene(["The recovery gap", "nobody talks about."],     WHITE, 2.5),
    make_scene(["Pre-workout? Yes.", "Recovery? Skipped."],     WHITE, 2.5),
    make_scene(["Everything you need", "for $35."],             GOLD,  3.0),
    make_scene(["Join the club."],                              GOLD,  2.0),
]
