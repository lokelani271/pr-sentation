"""
v5_2.mp4 — 11s, 4 scenes with crossfades
...
SCENES = [
    (["WISH YOU HAD A", "RESET BUTTON?"],      WHITE, 120, True,  GOLD,  0.0, 2.0),
    (["IMAGINE PRESSING", "IT ANYWHERE."],     WHITE, 110, False, WHITE, 2.0, 5.0),
    (["AURAEASE IS THE", "CLOSEST THING."],    GOLD,  110, False, WHITE, 5.0, 9.0),
    (["PUSH THE BUTTON."],                     GOLD,  115, False, WHITE, 9.0, 11.0),
]
